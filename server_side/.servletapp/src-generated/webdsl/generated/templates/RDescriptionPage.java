...
@SuppressWarnings("all")public class RDescriptionPage extends utils.PageServlet{
...
conversion();
loadArguments();
Object[] args=new Object[]{tdlistname_,tditemname_};
this.args=args;
}
protected void initTemplateClass(){
templateservlet=new RDescription_Template();
}
...
combinedparams.append("{\"name\":\"").append("tdlistname").append("\", \"value\":\"").append(utils.HTMLFilter.filterEcmaWithinHTML(tdlistname_.toString())).append("\"},");
combinedparams.append("{\"name\":\"").append("tditemname").append("\", \"value\":\"").append(utils.HTMLFilter.filterEcmaWithinHTML(tditemname_.toString())).append("\"},");
}
public void urlQueryParams(java.lang.StringBuilder combinedparams){
combinedparams.append("tdlistname").append("=").append(utils.HTMLFilter.filter(utils.URLFilter.filter(tdlistname_.toString()))).append("&");
combinedparams.append("tditemname").append("=").append(utils.HTMLFilter.filter(utils.URLFilter.filter(tditemname_.toString()))).append("&");
}
public void hiddenParams(java.lang.StringBuilder combinedparams){
combinedparams.append("<input type=\"hidden\" name=\"").append("tdlistname").append("\" value=\"").append(utils.HTMLFilter.filter(tdlistname_.toString())).append("\" />");
combinedparams.append("<input type=\"hidden\" name=\"").append("tditemname").append("\" value=\"").append(utils.HTMLFilter.filter(tditemname_.toString())).append("\" />");
}
...
if(parammap.get("tdlistname")!=null){
tdlistname_=parammap.get("tdlistname");
}
if(parammap.get("tditemname")!=null){
tditemname_=parammap.get("tditemname");
}
}
