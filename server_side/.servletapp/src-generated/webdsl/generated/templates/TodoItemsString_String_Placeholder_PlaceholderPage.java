...
@SuppressWarnings("all")public class TodoItemsString_String_Placeholder_PlaceholderPage extends utils.PageServlet{
...
conversion();
loadArguments();
Object[] args=new Object[]{focusedListName_,focusedItemName_,ph_,ph3_};
this.args=args;
}
protected void initTemplateClass(){
templateservlet=new todoItemsString_String_Placeholder_Placeholder_Template();
}
