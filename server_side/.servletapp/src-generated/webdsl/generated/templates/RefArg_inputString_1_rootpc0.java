...
@SuppressWarnings("all")public class RefArg_inputString_1_rootpc0 extends utils.RefArg{
public webdsl.generated.domain.User newuser_;
public  RefArg_inputString_1_rootpc0(){}
public  RefArg_inputString_1_rootpc0(Object newuser_){
this.newuser_=(webdsl.generated.domain.User)newuser_;
}
public webdsl.generated.domain.User set(Object obj){
newuser_.setUsername((String)org.webdsl.tools.Utils.cast(obj,String.class));
return newuser_;
}
public Object get(){
return (String)newuser_.getUsername();
}
...
return newuser_.getId()+"!"+"RefArg_inputString_1_rootpc0";
}
...
newuser_.validateUsername_internalValidationExceptionMultiple_(vem);
