...
public @SuppressWarnings("all")class $Override$logout_Template extends utils.TemplateServlet{
public static void loadLiftedTemplateMap(org.webdsl.lang.Environment staticEnv){
utils.AbstractPageServlet.loadTemplateMap(webdsl.generated.templates.$Override$logout_s_ad0String_Template.class,null,staticEnv);
}
public static void loadRefArgClasses(java.util.Map<String,Class<?>> refargclasses){
utils.AbstractPageServlet.loadRefArgClasses($Override$logout_s_ad0String_Template.class);
}
public static org.webdsl.lang.Environment loadTemplateMap(String keyOverwrite,org.webdsl.lang.Environment staticEnv){
staticEnv.putTemplate(keyOverwrite==null?"logout":keyOverwrite,$Override$logout_Template.class);
utils.AbstractPageServlet.loadLiftedTemplateMap($Override$logout_Template.class);
return staticEnv;
}
...
try{
handleTemplateCall(phase,inForLoop,forelementcounter,"tcall_2434237820","wrapsubmitString",env.addExtraLocalTemplateArgumentsToArguments(new Object[]{"$Override$logout_logout1"+webdsl.generated.functions.getTemplate_.getTemplate_().getUniqueIdNoCache()},"wrapsubmitString"),new org.webdsl.lang.Environment(env).putWithcall("s",new utils.TemplateCall("$Override$logout_s_ad0String",getElementsContext(),org.apache.commons.lang3.ArrayUtils.EMPTY_OBJECT_ARRAY,attrs)),"wrapsubmitString",utils.TemplateCall.EmptyAttrs);
}
catch(RuntimeException ex){
printTemplateCallException(ex,"wrapsubmitString(\"$Override$logout_logout1\" + getTemplate().getUniqueIdNoCache()) at unknown context");
}
}
if(RENDER_PHASE==phase){
out.print("</form>");
