...
@SuppressWarnings("unchecked")public class ToDoListAllowedUsersOwnedListType extends utils.AbstractOwnedListType{
private static final String[] _filters=(String[])null;
@Override public Object instantiate(int anticipatedSize){
return new ToDoListAllowedUsersList(anticipatedSize<1?0:anticipatedSize);
}
