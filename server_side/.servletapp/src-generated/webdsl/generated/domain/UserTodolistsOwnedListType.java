...
@SuppressWarnings("unchecked")public class UserTodolistsOwnedListType extends utils.AbstractOwnedListType{
private static final String[] _filters=(String[])null;
@Override public Object instantiate(int anticipatedSize){
return new UserTodolistsList(anticipatedSize<1?0:anticipatedSize);
}
