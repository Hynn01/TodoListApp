...
@SuppressWarnings("unchecked")public class ToDoListTodoitemsOwnedListType extends utils.AbstractOwnedListType{
private static final String[] _filters=(String[])null;
@Override public Object instantiate(int anticipatedSize){
return new ToDoListTodoitemsList(anticipatedSize<1?0:anticipatedSize);
}
