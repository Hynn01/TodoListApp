...
@SuppressWarnings("all")public class authenticateString_Secret_{
public static Boolean authenticateString_Secret_(String credusername_,String credpassword_){
java.util.List<webdsl.generated.domain.User> tmpentitylist_=webdsl.generated.domain.User._static_findByUsername_(credusername_);
