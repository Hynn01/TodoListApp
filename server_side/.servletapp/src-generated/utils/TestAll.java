...
utils.HibernateUtil.getCurrentSession().createQuery("delete from "+"ToDoItem").executeUpdate();
utils.HibernateUtil.getCurrentSession().createQuery("delete from "+"ToDoList").executeUpdate();
