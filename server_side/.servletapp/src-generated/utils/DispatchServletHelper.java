...
String[] s={};
Boolean[] b={};
pages.put("User",new utils.PageDispatch(UserPage.class,s,b,false));
}
{
String[] s={};
Boolean[] b={};
pages.put("TodoList",new utils.PageDispatch(TodoListPage.class,s,b,false));
}
{
String[] s={"tdlistname"};
Boolean[] b={false};
pages.put("TodoItem",new utils.PageDispatch(TodoItemPage.class,s,b,false));
}
{
String[] s={};
Boolean[] b={};
pages.put("Status",new utils.PageDispatch(StatusPage.class,s,b,false));
}
{
String[] s={};
Boolean[] b={};
...
String[] s={};
Boolean[] b={};
pages.put("registartionService",new utils.PageDispatch(RegistartionServicePage.class,s,b,false));
}
{
String[] s={"tdlistname","tditemname"};
Boolean[] b={false,false};
pages.put("RDescription",new utils.PageDispatch(RDescriptionPage.class,s,b,false));
}
{
String[] s={};
Boolean[] b={};
...
String[] s={};
Boolean[] b={};
pages.put("logoutService",new utils.PageDispatch(LogoutServicePage.class,s,b,false));
}
{
String[] s={};
Boolean[] b={};
...
String[] s={};
Boolean[] b={};
pages.put("home",new utils.PageDispatch(HomePage.class,s,b,false));
}
{
String[] s={};
Boolean[] b={};
pages.put("getTodoItem",new utils.PageDispatch(GetTodoItemPage.class,s,b,false));
}
{
String[] s={};
Boolean[] b={};
pages.put("getRDescription",new utils.PageDispatch(GetRDescriptionPage.class,s,b,false));
}
{
String[] s={};
Boolean[] b={};
pages.put("deleteTodoList",new utils.PageDispatch(DeleteTodoListPage.class,s,b,false));
}
{
String[] s={};
Boolean[] b={};
pages.put("deleteTodoItem",new utils.PageDispatch(DeleteTodoItemPage.class,s,b,false));
}
{
String[] s={};
Boolean[] b={};
pages.put("Date",new utils.PageDispatch(DatePage.class,s,b,false));
}
{
String[] s={};
Boolean[] b={};
...
{
String[] s={"focusedListId","ph","ph2","ph3"};
Boolean[] b={false,false,false,false};
pages.put("todoListsUUID_Placeholder_Placeholder_Placeholder",new utils.PageDispatch(TodoListsUUID_Placeholder_Placeholder_PlaceholderPage.class,s,b,true));
}
{
String[] s={"focusedListName","focusedItemName","ph","ph3"};
Boolean[] b={false,false,false,false};
pages.put("todoItemsString_String_Placeholder_Placeholder",new utils.PageDispatch(TodoItemsString_String_Placeholder_PlaceholderPage.class,s,b,true));
}
{
String[] s={"list"};
Boolean[] b={false};
...
{
String[] s={"focusedListName","focusedItemName","ph"};
Boolean[] b={false,false,false};
pages.put("descriptionString_String_Placeholder",new utils.PageDispatch(DescriptionString_String_PlaceholderPage.class,s,b,true));
}
}
